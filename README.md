...
선택 가능한 텍스트 PDF를, Chrome에서 번역해 읽는 HTML 뷰어로 바꿉니다.

통째로 AI에 번역시키지 않습니다. 본문은 원문 HTML로 두고, 브라우저 번역이 문장·표·캡션에 걸리게 합니다. 색, 2단 측주, 표, 그림은 PDF에서 가져옵니다.
...
- `--lang` 원문 언어. 기본 `auto` (글자에서 추정). Chrome 번역의 출발 언어입니다.
